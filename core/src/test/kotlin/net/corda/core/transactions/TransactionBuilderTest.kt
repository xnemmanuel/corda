...
class TransactionBuilderTest {
    ...
    private val unsignedAttachment = ContractAttachment(object : AbstractAttachment("test", { byteArrayOf() }) {
        override val id: SecureHash get() = throw UnsupportedOperationException()

        override val signerKeys: List<PublicKey> get() = emptyList()
    }, DummyContract.PROGRAM_ID)

    private fun signedAttachment(vararg parties: Party) = ContractAttachment.create(object : AbstractAttachment("test", { byteArrayOf() }) {
        override val id: SecureHash get() = throw UnsupportedOperationException()
