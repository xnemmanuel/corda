...
class MockAttachmentStorage : AttachmentStorage, SingletonSerializeAsToken() {
    ...
    private class MockAttachment(dataLoader: () -> ByteArray, override val id: SecureHash, override val signerKeys: List<PublicKey>, uploader: String) : AbstractAttachment(uploader, dataLoader)
